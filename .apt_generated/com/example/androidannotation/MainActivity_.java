    ...
    implements HasViews, OnViewChangedListener
{
    ...
    public void onViewChanged(HasViews hasViews) {
        ...
        openMusicBtn = ((Button) hasViews.findViewById(id.btn_music));
        if (button!= null) {
        ...
        if (openMusicBtn!= null) {
            openMusicBtn.setOnClickListener(new OnClickListener() {


                @Override
                public void onClick(View view) {
                    MainActivity_.this.openMusicPlayer();
                }
